...
!-----------------------------------------------------------------
      ...
      write(*,*) 'main_bc_wrfchem: read c3h values on half (mass) levels'
!-----------------------------------------------------------------
...
!-----------------------------------------------------------------
          if( do_ic .and. it == 1 ) then
            ...
            call ic_interpolate4d( ns, spc_ic, ps_wrf, znu, c3h, p_top, &
                                   nx, ny, nz )
...
!-----------------------------------------------------------------
      ...
      deallocate( znu, c3h, xlon, xlat, bcxs, bcxe, bcys, bcye,    &
